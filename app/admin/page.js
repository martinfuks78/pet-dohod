            ...
            <div className="flex justify-end gap-3">
              {workshopTemplates.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-white text-primary-600 border-2 border-primary-600 rounded-lg hover:bg-primary-50 transition-colors font-semibold"
                >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors font-semibold"
              >
